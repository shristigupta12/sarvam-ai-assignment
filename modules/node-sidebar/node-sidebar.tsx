...
const NodeSidebar: React.FC = () => {
  ...
  return (
    <motion.aside 
      className="border-r border-neutral-300 bg-white h-full overflow-y-auto flex flex-col"
    ...
    >
      <div className={`flex gap-2 justify-between items-center px-5 py-3`}>
      ...
      <div className={`flex flex-col gap-2 w-full text-neutral-600 py-2  ${isOpen ? "px-4 items-start" : "px-2 items-center "}`}>
